...
path('ViewExpenseRequests/', views.ViewVolunteerExpenseRequests, name='ViewExpenseRequests'),
path('ApproveExpense/<int:id>', views.ApproveExpenseRequest, name='ApproveExpense'),
path('RejectExpense/<int:id>', views.RejectExpenseRequest, name='RejectExpense'),
path('PayExpenseRequest/<int:id>', views.PayExpenseRequestPage, name='PayExpenseRequest'),
path('PaymentProcessing/', views.PaymentProcessing, name='PaymentProcessing'),
path('CompleteExpensePayment/', views.CompleteExpensePayment, name='CompleteExpensePayment'),
]
